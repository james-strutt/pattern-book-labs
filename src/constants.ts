...
export const SELECTED_SITES_LAYER_NAME = "Selected Sites";
export const SELECTED_SITE_LAYER_NAME = "Selected Site";
export const SITE_SETBACK_LAYER_NAME = "Site Setback";

/** localStorage key for Pattern envelope setback UI (Main2). */
export const ENVELOPE_SETBACK_PARAMS_STORAGE_KEY = "pattern:envelopeSetbackParams";

export type EnvelopeSetbackParams = {
  front: number;
  rear: number;
  side: number;
};
...
/** Max setback (m) for Main2 envelope NumberInputs. */
export const ENVELOPE_SETBACK_INPUT_MAX_M = 10;

export const PATTERN_MAIN_SORT_OPTIONS: readonly SortType[] = [SortType.AREA, SortType.FSR, SortType.DWELLINGS];
...
export const BATTLE_AXE_NARROW_THRESHOLD_RATIO = 0.4;
export const BATTLE_AXE_NARROW_THRESHOLD_METER = 6;
export const BATTLE_AXE_NARROW_THRESHOLD_COUNT = 20;
...
export const PATTERN_BOOK_SHORT_LIST = {
  ...
  nodes: [
    ...
    },
    {
      ...
      data: {
        ...
        defaultValue: ["b7e1d65b312e4d60a65463857af07bb8", "dddd", null],
      },
    ...
    },
    {
      ...
      data: {
        name: "rotation",
        type: "string",
        defaultValue: '{"444b634388694c898af93f3a35043a5e": 1, "b": 2, "c": 3}',
      },
      type: "71b71b93-a9ed-432f-94c4-b19cf60aa85b",
      position: {
        x: -539,
  ...
  inputs: {
    keys: {
      name: "keys",
      type: "string",
      default: ["b7e1d65b312e4d60a65463857af07bb8", "dddd", null],
      description: "the keys to pick",
      isList: true,
    },
    point: {
    ...
    rotation: {
      name: "rotation",
      type: "string",
      default: '{"444b634388694c898af93f3a35043a5e": 1, "b": 2, "c": 3}',
    },
    feature: {
      name: "feature",
      type: "feature",
